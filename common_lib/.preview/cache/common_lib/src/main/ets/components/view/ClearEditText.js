export class ClearEditText extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("components/view/ClearEditText.ets(16:5)");
            Row.height(45);
            Row.width('100%');
            if (!isInitialRender) {
                Row.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("components/view/ClearEditText.ets(17:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (!this.isEmpty) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Image.create($r('app.media.icon_close'));
                        Image.debugLine("components/view/ClearEditText.ets(35:9)");
                        Image.height('100%');
                        Image.aspectRatio(1);
                        Image.padding(15);
                        Image.onClick(() => {
...
if (getPreviewComponentFlag()) {
    ...
    storePreviewComponents(1, "ClearEditText", new ClearEditText(undefined, {}));
}
