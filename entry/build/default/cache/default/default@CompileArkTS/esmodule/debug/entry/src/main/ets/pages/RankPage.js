...
class RankPage extends ViewPU {
    ...
    onBackPress() {
        if (this.isShowToast()) {
            prompt.showToast({
                message: { "id": 33554457, "type": 10003, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" },
                duration: TIME
            });
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.backgroundColor({ "id": 33554459, "type": 10001, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" });
