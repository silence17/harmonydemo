...
export class ListItemComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("view/ListItemComponent.ets(34:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("view/ListItemComponent.ets(35:7)");
            ...
            if (this.isRenderCircleText()) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("view/ListItemComponent.ets(41:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ListItemComponent.ets(52:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ListItemComponent.ets(57:7)");
    ...
    CircleText(index, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/ListItemComponent.ets(85:5)");
            ...
            Row.backgroundColor({ "id": 33554474, "type": 10001, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" });
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create((_a = this.index) === null || _a === void 0 ? void 0 : _a.toString());
            Text.debugLine("view/ListItemComponent.ets(86:7)");
            Text.fontWeight(FontWeight.BOLD);
            Text.fontSize(FontSize.SMALL);
