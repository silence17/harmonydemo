...
export class ListHeaderComponent extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 33554465, "type": 10003, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" });
            ...
            Text.fontColor({ "id": 33554475, "type": 10001, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 33554466, "type": 10003, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 33554467, "type": 10003, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" });
