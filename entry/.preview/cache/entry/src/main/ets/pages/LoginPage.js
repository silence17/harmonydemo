...
class LoginPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.__viewModel = new ObservedPropertyObjectPU(new LoginViewModel(), this, "viewModel");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/LoginPage.ets(27:5)");
            Column.height('100%');
        ...
        });
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new 
                    //title
                    CommonTitleComponent(this, { title: { "id": 33554463, "type": 10003, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" }, callback: () => {
                            //todo
                        } }, undefined, elmtId));
                }
                else {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/LoginPage.ets(37:7)");
            // Text(this.userInfo.nickName)
            //   .fontSize(30)
            //   .fontColor(Color.Red)
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/LoginPage.ets(42:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/LoginPage.ets(47:7)");
            Row.margin({ top: 5 });
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('没有账号?');
            Text.debugLine("pages/LoginPage.ets(48:9)");
            Text.fontColor('#333333');
            Text.fontSize(13);
            if (!isInitialRender) {
                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('立即注册');
            Text.debugLine("pages/LoginPage.ets(51:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Line.create();
            Line.debugLine("pages/LoginPage.ets(76:7)");
            Line.height(0.5);
            Line.stroke('#D1D1D1');
            Line.startPoint([0, 0]);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Line.create();
            Line.debugLine("pages/LoginPage.ets(88:7)");
            Line.height(0.5);
            Line.stroke('#D1D1D1');
            Line.startPoint([0, 0]);
            Line.endPoint([Math.round((this.screenWidth) - 30), 0]);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/LoginPage.ets(94:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('忘记密码');
            Text.debugLine("pages/LoginPage.ets(104:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/LoginPage.ets(113:7)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/LoginPage.ets(114:9)");
            Image.width(23);
            Image.height(23);
            if (!isInitialRender) {
                Image.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('服务协议、');
            Text.debugLine("pages/LoginPage.ets(121:9)");
            Text.fontSize(13);
            Text.fontColor('#1890FF');
            Text.onClick(() => {
                promptAction.showToast({
