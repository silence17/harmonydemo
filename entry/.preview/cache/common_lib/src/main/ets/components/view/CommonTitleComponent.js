...
export class CommonTitleComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("../../../../common_lib/src/main/ets/components/view/CommonTitleComponent.ets(33:5)");
            Flex.width('100%');
            Flex.height(48);
            if (!isInitialRender) {
                Flex.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("../../../../common_lib/src/main/ets/components/view/CommonTitleComponent.ets(34:7)");
            Image.height(48);
            Image.width(48);
            Image.padding(14);
            Image.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("../../../../common_lib/src/main/ets/components/view/CommonTitleComponent.ets(42:7)");
            Text.fontSize(20);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("../../../../common_lib/src/main/ets/components/view/CommonTitleComponent.ets(47:7)");
            Text.width(48);
            Text.height(48);
            Text.onClick((event) => {
